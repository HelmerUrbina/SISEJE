...
@WebServlet(name = "IduPrioridadServlet", urlPatterns = {"/IduPrioridad"})
public class IduPrioridadServlet extends HttpServlet {
    ...
    private PrioridadDAO objDsPrioridad;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        objDsPrioridad = new PrioridadDAOImpl(objConnection);
        // EJECUTAMOS EL PROCEDIMIENTO SEGUN EL MODO QUE SE ESTA TRABAJANDO
        int k = objDsPrioridad.iduPrioridad(objBnArea, objUsuario.getUsuario());
