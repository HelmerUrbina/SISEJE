...
@WebServlet(name = "IduSeccionesServlet", urlPatterns = {"/IduSecciones"})
public class IduSeccionesServlet extends HttpServlet {

    private ServletConfig config = null;
    private ServletContext context = null;
    private HttpSession session = null;
    private RequestDispatcher dispatcher = null;
    private BeanComun objBnArea;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int k = objDsSecciones.iduSecciones(objBnArea, objUsuario.getUsuario());
