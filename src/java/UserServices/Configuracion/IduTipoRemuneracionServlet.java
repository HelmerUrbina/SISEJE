 ...
 * @author helme
 */
@WebServlet(name = "IduTipoRemuneracionServlet", urlPatterns = {"/IduTipoRemuneracion"})
public class IduTipoRemuneracionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        objBnTipoRemuneracion.setDescripcion(request.getParameter("descripcion"));
        objBnTipoRemuneracion.setTipo(request.getParameter("tipo"));
        objBnTipoRemuneracion.setEstado(request.getParameter("estado"));
        objDsTipoRemuneracion = new TipoRemuneracionDAOImpl(objConnection);
        // EJECUTAMOS EL PROCEDIMIENTO SEGUN EL MODO QUE SE ESTA TRABAJANDO
        int k = objDsTipoRemuneracion.iduTipoRemuneracion(objBnTipoRemuneracion, objUsuario.getUsuario());
