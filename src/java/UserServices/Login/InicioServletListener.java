...
public class InicioServletListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        if (objConnection != null) {
            ...
            System.out.println("SE HA CONECTADO SATISFACTORIAMENTE............ SISEJE");
        } else {
            System.out.println("PROBLEMAS AL CONECTAR............ SISEJE");
        }
    }
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        ...
        System.out.println("CONEXION SISEJE ...... CERRADO CORRECTAMENTE.");
    }
}
