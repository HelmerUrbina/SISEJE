...
public class IduTipoDecretosServlet extends HttpServlet {
    ...
    private BeanComun objBnTipoDecreto;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String result = null;
        objBnTipoDecreto = new BeanComun();
        objBnTipoDecreto.setMode(request.getParameter("mode"));
        objBnTipoDecreto.setCodigo(request.getParameter("codigo"));
        objBnTipoDecreto.setDescripcion(request.getParameter("descripcion"));
        objBnTipoDecreto.setEstado(request.getParameter("estado"));
        objDsTipoDecretos = new TipoDecretosDAOImpl(objConnection);
        // EJECUTAMOS EL PROCEDIMIENTO SEGUN EL MODO QUE SE ESTA TRABAJANDO
        int k = objDsTipoDecretos.iduTipoDecretos(objBnTipoDecreto, objUsuario.getUsuario());
