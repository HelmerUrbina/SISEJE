...
@WebServlet(name = "ReportesGestionServlet", urlPatterns = {"/ReportesGestion"})
public class ReportesGestionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (request.getParameter("mode")) {
            case "reportes":
                dispatcher = request.getRequestDispatcher("Reportes/Reportes.jsp");
                break;
            default:
