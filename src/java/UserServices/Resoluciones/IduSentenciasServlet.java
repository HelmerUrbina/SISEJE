...
@WebServlet(name = "IduSentenciasServlet", urlPatterns = {"/IduSentencias"})
public class IduSentenciasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        java.util.Date fecha = sdf.parse(Utiles.Utiles.checkFecha(request.getParameter("fecha")));
        ...
        objBnSentencias.setOficio(request.getParameter("motivo"));
        objBnSentencias.setFecha(new java.sql.Date(fecha.getTime()));
        objDsSentencias = new SentenciasDAOImpl(objConnection);
        // EJECUTAMOS EL PROCEDIMIENTO SEGUN EL MODO QUE SE ESTA TRABAJANDO
        int k = objDsSentencias.iduSentencias(objBnSentencias, objUsuario.getUsuario());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(IduSentenciasServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
