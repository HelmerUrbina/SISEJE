    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function NuevoRegistro() {
                ...
                $('#RegistrarPeriodos .modal-content').removeAttr('class').addClass('modal-content modal-col-default');
                $('#RegistrarPeriodos').modal('show');
            }
            function EditarRegistro(xCodigo) {
                ...
                $.ajax({
                    type: "GET",
                    url: "Periodos",
                    data: {mode: mode, codigo: xCodigo},
                    success: function (data) {
                        var dato = data.trim().split("+++");
                        if (dato.length === 3) {
                            $('#txt_Periodo').val(dato[0]);
            ...
            function GuardarDatos() {
                ...
                $.ajax({
                    type: "POST",
                    url: "IduPeriodos",
                    data: {mode: mode, periodo: periodo, descripcion: descripcion, estado: estado},
                    success: function (data) {
                        msg = data;
                        if (msg === "GUARDO") {
                            swal({
            ...
            function Refrescar() {
                window.location = "Periodos?mode=periodos";
            }
        </script>
    </head>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="block-header">
                    <h3><strong>Administración de Periodos</strong></h3>
                </div>
                        ...
                        <div class="card">
                            <div class="body"> 
                                ...
                                <div class="tab-content">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <c:choose>
                                                                                ...
                                                                                <c:when test="${d.estado=='CERRADO'}">
                                                                                    <span class="badge bg-blue">${d.estado}</span>
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <button type="button" class="btn btn-primary btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Editar Periodo" onclick="javascript: EditarRegistro('${d.codigo}');">
                                                                                <i class="material-icons">mode_edit</i>
                                                                            </button>
                                                                            <button type="button" class="btn bg-pink btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Anular Periodo" onclick="javascript: EliminarRegistro('${d.codigo}');">
                                    ...
                                    <!-- Modal Dialogs -->
                                    <!-- Default Size -->
                                    <div class="modal fade" id="RegistrarPeriodos" tabindex="-1" role="dialog">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="defaultModalLabel">REGISTRO DE PERIODOS</h4>
                                                </div>
                                                    ...
                                                    <div class="row clearfix">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <input type="text" id="txt_Periodo" class="form-control" maxlength="4" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
