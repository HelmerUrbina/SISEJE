    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function NuevoRegistro() {
                ...
                $('#RegistrarPrioridad .modal-content').removeAttr('class').addClass('modal-content modal-col-default');
                $('#RegistrarPrioridad').modal('show');
            }
            ...
            function Refrescar() {
                window.location = "Prioridad?mode=prioridad";
            }
        </script>
    </head>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="block-header">
                    <h3><strong>Administración de Prioridades</strong></h3>
                </div>
                        ...
                        <div class="card">
                            <div class="body"> 
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="card">
                                                    <div class="header bg-teal">
                                                        <h2 class="col-md-10 col-sm-9 col-xs-8">
                                                            <strong>Listado de Prioridades</strong>
                                                        </h2>
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="d" items="${objPrioridad}">
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <button type="button" class="btn btn-primary btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Editar Prioridad" onclick="javascript: EditarRegistro('${d.codigo}');">
                                                                                <i class="material-icons">mode_edit</i>
                                                                            </button>
                                                                            <button type="button" class="btn bg-pink btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Anular Prioridad" onclick="javascript: EliminarRegistro('${d.codigo}');">
                                    ...
                                    <!-- Modal Dialogs ====================================================================================================================== -->
                                    <!-- Default Size -->
                                    <div class="modal fade" id="RegistrarPrioridad" tabindex="-1" role="dialog">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="defaultModalLabel">REGISTRO DE PRIORIDADES</h4>
                                                </div>
