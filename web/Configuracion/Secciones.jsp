    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function NuevoRegistro() {
                ...
                $('#RegistrarSecciones .modal-content').removeAttr('class').addClass('modal-content modal-col-default');
                $('#RegistrarSecciones').modal('show');
            }
            ...
            function Refrescar() {
                window.location = "Secciones?mode=secciones";
            }
        </script>
    </head>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="block-header">
                    <h3><strong>Administración de Secciones</strong></h3>
                </div>
                        ...
                        <div class="card">
                            <div class="body"> 
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="ListarSecciones">
                                        <!-- Striped Rows -->
                                        <div class="row clearfix">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="card">
                                                    <div class="header bg-teal">
                                                        <h2 class="col-md-10 col-sm-9 col-xs-8">
                                                            <strong>Listado de Secciones</strong>
                                                        </h2>
                                                    ...
                                                    <div class="body">
                                                        <table id="TablaResultados">
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="d" items="${objSecciones}">
                                                                    <tr>
                                                                        <td>${d.descripcion}</td>
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <button type="button" class="btn btn-primary btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Editar Sección" onclick="javascript: EditarRegistro('${d.codigo}');">
                                                                                <i class="material-icons">mode_edit</i>
                                                                            </button>
                                                                            <button type="button" class="btn bg-pink btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Anular Sección" onclick="javascript: EliminarRegistro('${d.codigo}');">
                                    ...
                                    <!-- Modal Dialogs ============================= -->
                                    <!-- Default Size -->
                                    <div class="modal fade" id="RegistrarSecciones" tabindex="-1" role="dialog">
                                                    ...
                                                    <div class="row clearfix">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <input type="text" id="txt_Descripcion" class="form-control" maxlength="100" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
