    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function NuevoRegistro() {
                ...
                $('#RegistrarTipoDecretos .modal-content').removeAttr('class').addClass('modal-content modal-col-default');
                $('#RegistrarTipoDecretos').modal('show');
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (msg === "GUARDO") {
                            ...
                            $('#RegistrarTipoDecretos').modal('hide');
                            Refrescar();
                        } else {
            ...
            function Refrescar() {
                window.location = "TipoDecretos?mode=tipoDecretos";
            }
        </script>
    </head>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="block-header">
                    <h3><strong>Administración de Tipo de Decretos</strong></h3>
                </div>
                        ...
                        <div class="card">
                            <div class="body"> 
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="ListarTipoDecretos">
                                        <!-- Striped Rows -->
                                        <div class="row clearfix">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="card">
                                                    <div class="header bg-teal">
                                                        <h2 class="col-md-10 col-sm-9 col-xs-8">
                                                            <strong>Listado de Tipo de Decretos</strong>
                                                        </h2>
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="d" items="${objTipoDecretos}">
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <button type="button" class="btn btn-primary btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Editar Tipo de Decreto" onclick="javascript: EditarRegistro('${d.codigo}');">
                                                                                <i class="material-icons">mode_edit</i>
                                                                            </button>
                                                                            <button type="button" class="btn bg-pink btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Anular Tipo de Decreto" onclick="javascript: EliminarRegistro('${d.codigo}');">
                                    ...
                                    <!-- Modal Dialogs ====================================================================================================================== -->
                                    <!-- Default Size -->
                                    <div class="modal fade" id="RegistrarTipoDecretos" tabindex="-1" role="dialog">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="defaultModalLabel"> REGISTRO DE TIPO DE DECRETOS</h4>
                                                </div>
