    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function fn_ProcesarDatos() {
                swal({
                    title: "¿Estás seguro?",
                    text: "¡Deseas Procesar los Descuentos!",
                    type: "input",
                    inputPlaceholder: "Tipo de Cambio - Dolares Americanos",
                    ...
                    if (inputValue === false)
                        return false;
                    if (inputValue === "") {
                        swal.showInputError("Tipo de Cambio de Dolares Americanos");
                        return false;
                    }
                    var periodo = $('#cbo_Periodo').val();
                    var mes = $('#cbo_Mes').val();
                        ...
                        success: function (data) {
                            if (data === 'GUARDO') {
                                swal({
                                    ...
                                    text: "Datos Procesado con Exito",
                                    timer: 2000,
            ...
            function fn_ImportarExcel() {
                flag = ".xlsx";
                $('#txt_Archivo').val('');
                $('#SubirArchivoSentencias .modal-content').removeAttr('class').addClass('modal-content modal-col-default');
                $('#SubirArchivoSentencias').modal('show');
            }
            function fn_ImportarTXT() {
                flag = ".txt";
                $('#txt_Archivo').val('');
                $('#SubirArchivoSentencias .modal-content').removeAttr('class').addClass('modal-content modal-col-default');
                $('#SubirArchivoSentencias').modal('show');
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (msg === "GUARDO") {
                                    ...
                                    $('#SubirArchivoSentencias').modal('hide');
                                    fn_BuscarDatos();
                                } else {
            ...
            function fn_VerificaArchivo() {
                ...
                if (flag === ".xlsx") {
                    ...
                    regex = /^([a-zA-Z0-9\s_\\.\-:])+(.txt)$/;
                    if (regex.test($("#txt_Archivo").val().toLowerCase())) {
                        if ($("#txt_Archivo").val().toLowerCase().indexOf(".txt") > 0) {
                            return '';
                        }
                    }
                    return "Por favor, cargue un archivo de Texto válido!";
                } else {
                        ...
                        <div class="card">
                            ...
                            <div class="body"> 
                                ...
                                <div class="tab-content">
                                    ...
                                    <!-- Modal Dialogs  -->
                                    <div class="modal fade" id="SubirArchivoSentencias" tabindex="-1" role="dialog">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <form id="frm_SentenciasMovimientoArchivo" name="frm_SentenciasMovimientoArchivo" enctype="multipart/form-data" action="javascript: fn_SubirArchivo();" method="post">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="defaultModalLabel">ADJUNTAR DOCUMENTO - SENTENCIAS MOVIMIENTO</h4>
                                                    </div>
