...
<html>
    <head>
        ...
        <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (dato.length === 2) {
                            ...
                            $('#cbo_Estado').selectpicker('val', dato[1]);
                            $('#RegistrarTipoJuzgados .modal-content').removeAttr('class').addClass('modal-content modal-col-default');
                            $('#RegistrarTipoJuzgados').modal('show');
                        }
                    }
            ...
            function Refrescar() {
                window.location = "TipoJuzgados?mode=tipoJuzgados";
            }
        </script>
    </head>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="block-header">
                    <h3><strong>Administración de Tipo de Juzgados</strong></h3>
                </div>
                                                ...
                                                <div class="card">
                                                    <div class="header bg-teal">
                                                        <h2 class="col-md-10 col-sm-9 col-xs-8">
                                                            <strong>Listado de Tipo de Juzgados</strong>
                                                        </h2>
                                                    ...
                                                    <div class="body">
                                                        <table id="TablaResultados">
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="d" items="${objTipoJuzgados}">
                                                                    <tr>
                                                                        <td>${d.descripcion}</td>
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <button type="button" class="btn btn-primary btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Editar Tipo de Juzgado" onclick="javascript: EditarRegistro('${d.codigo}');">
                                                                                <i class="material-icons">mode_edit</i>
                                                                            </button>
                                                                            <button type="button" class="btn bg-pink btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Anular Tipo de Juzgado" onclick="javascript: EliminarRegistro('${d.codigo}');">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="defaultModalLabel"> REGISTRO DE TIPO DE JUZGADOS</h4>
                                                </div>
