...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function verPersonal() {
                ...
                if (numeroDocumento.length === 11) {
                    $.ajax({
                        type: "GET",
                        url: "Combos",
                        data: {accion: 'RAZONSOCIAL', codigo: numeroDocumento},
                        success: function (data) {
                            $('#txt_RazonSocial').val(data);
            ...
            function CerrarResolucion(xResolucion) {
                swal({
                    title: "¿Estás seguro?",
                    ...
                    $.ajax({
                        ...
                        data: {mode: 'C', cip: cip, sentencia: sentencia, resolucion: xResolucion},
                        success: function (data) {
                            msg = data;
                            if (msg === "GUARDO") {
                                swal({
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="block-header">
                    <h3><strong>Verificación de Sentencias Judiciales</strong></h3>
                </div>
                            ...
                            <div class="header">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="txt_Personal" class="form-control" disabled="disabled">
                                            </div>
                                        </div>
                                    </div>
                                    <div>
