    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function NuevoRegistro() {
                ...
                $('#RegistrarModulos .modal-content').removeAttr('class').addClass('modal-content modal-col-default');
                $('#RegistrarModulos').modal('show');
            }
            ...
            function Refrescar() {
                window.location = "Modulos?mode=modulos";
            }
        </script>
    </head>
                        ...
                        <div class="card">
                            <div class="body"> 
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="card">
                                                    <div class="header bg-teal">
                                                        <h2 class="col-md-10 col-sm-9 col-xs-8">
                                                            <strong>Listado de Módulos</strong>
                                                        </h2>
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="d" items="${objModulos}">
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <button type="button" class="btn btn-primary btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Editar Módulo" onclick="javascript: EditarRegistro('${d.codigo}');">
                                                                                <i class="material-icons">mode_edit</i>
                                                                            </button>
                                                                            <button type="button" class="btn bg-pink btn-xs waves-effect" data-toggle="tooltip" data-placement="bottom" title="Anular Módulo" onclick="javascript: EliminarRegistro('${d.codigo}');">
                                    ...
                                    <!-- Modal Dialogs -->
                                    <!-- Default Size -->
                                    <div class="modal fade" id="RegistrarModulos" tabindex="-1" role="dialog">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="defaultModalLabel"> REGISTRO DE MÓDULOS</h4>
                                                </div>
